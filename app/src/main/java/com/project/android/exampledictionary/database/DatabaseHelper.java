...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor getMeaning(String text) {
        Cursor c = myDataBase.rawQuery("SELECT en_definition, en_wordtype FROM words WHERE en_word == UPPER('" + text + "')", null);
        return c;
    }
    ...
    public void insertFavorite(String text) {
        myDataBase.execSQL("INSERT INTO favorite(word) VALUES(UPPER('" + text + "'))");
    }

    public Cursor getFavorite() {
        Cursor c = myDataBase.rawQuery("SELECT * FROM favorite", null);
        return c;
    }

    public void deleteFavorite(String text) {
        myDataBase.execSQL("DELETE FROM favorite" + " WHERE word " + "='" + text + "'");
    }
}
